...
This project contains Python scripts (`data_collector.py`) for collecting real-time cryptocurrency trade and price data from the ASTER exchange using websockets.
